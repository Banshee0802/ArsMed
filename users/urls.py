...
from .views import (
                    ...
                    ScheduleRequestsView, SearchPatientsView,
                    toggle_day_status, AdminPatientCreateView,
...
urlpatterns = [
    ...
    path('profile/schedules/search-patients/', SearchPatientsView.as_view(), name='search_patients'),
    path('profile/schedules/toggle-day/', toggle_day_status, name='admin_schedule_toggle_day'),
    path('profile/patients/add/', AdminPatientCreateView.as_view(), name="admin_patient_add"),
